...
import com.phase1project.lockedme.model.UserCredentials;
import com.phase1project.lockedme.model.Users;
...
public class Authentications{
	...
	public static void signInOptions() {
		...
		for (;;) {
			System.out.println("Press 1 for Registration and Press 2 for login and press 3 for close");
